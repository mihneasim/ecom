...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # because sqlite3 and autocommit ..
        #orm['address.Country'].objects.get_or_create(pk='RO',
        #        defaults={
        orm['address.Country'].objects.create(pk='RO', **{
            "iso_3166_1_a3": "ROU",
            "name": "ROMANIA",
        ...
        product_class_name = raw_input("Initial product class: ")
        partner_name = raw_input("Initial fulfillment partner: ")
        orm['catalogue.ProductClass'].objects.create(
                **{"track_stock": True,
                   "requires_shipping": True,
                   "name": product_class_name,
                   "slug": slugify(product_class_name)})
        orm['partner.Partner'].objects.create(
                **{"code": "partener", "name": partner_name})

    def backwards(self, orm):
        "Write your backwards methods here."
        orm['address.Country'].objects.filter(pk='RO').delete()
        print "Delete product class and fulfillment partner manually"
    ...
    complete_apps = ['address', 'catalogue', 'partner', 'oscaro']
    symmetrical = True
